...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="helloService" class="com.personu.springboot.service.HelloService"></bean>
</beans>
```
...
```properties
logging.level.com.personu=trace
...
public class MyMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
       // super.addViewControllers(registry);
        //浏览器发送 /person 请求来到 success
        registry.addViewController("/person").setViewName("success");
    }
}
```
...
public class MyMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
       // super.addViewControllers(registry);
        //浏览器发送 /personu 请求来到 success
        registry.addViewController("/personu").setViewName("success");
    }
...
<form>
    ...
    <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" placeholder="zhangsan@personu.com">
    </div>
    <div class="form-group">
...
-->
    ...
    <div class="form-group">
        <label>Email</label>
        <input name="email" type="email" class="form-control" placeholder="zhangsan@personu.com" th:value="${emp!=null}?${emp.email}">
    </div>
    <div class="form-group">
        <label>Gender</label><br/>
        <div class="form-check form-check-inline">
...
@MapperScan(value = "com.personu.springboot.mapper")
@SpringBootApplication
...
com.personu.springboot.listener.HelloApplicationContextInitializer

org.springframework.boot.SpringApplicationRunListener=\
com.personu.springboot.listener.HelloSpringApplicationRunListener
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.person.starter</groupId>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.person.starter</groupId>
            <artifactId>person-spring-boot-starter-autoconfigurer</artifactId>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <name>person-spring-boot-starter-autoconfigurer</name>
...
@ConfigurationProperties(prefix = "person.hello")
...
public class HelloService {
    ...
    public String sayHellperson(String name){
